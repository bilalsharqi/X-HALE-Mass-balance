...
% title(['ATV 2018 (average XCG = ',num2str(stats_atv.xcg*100),' %) ']);
ylabel('CG Position in % of Chord','fontweight','bold','FontSize',12);
xlabel('Station # on the craft','fontweight','bold','FontSize',12);
xlim([-3,3]), ylim([0,100]);
set(gca,'Ydir','reverse');
set(gca,'Xticklabel',{' ','3','1','0','2','4'});
text(span,stats_atv.mean_cg,txt_cg_atv,'HorizontalAlignment','left','fontweight','bold','fontsize',12)

subplot(2,1,2)
errorbar(span,stats_rrv.mean_cg,stats_rrv.stdcg,'r.','LineWidth',2);
title(['RRV Config 1 (average XCG = ',num2str(stats_rrv.xcg*100),' %) ']);
ylabel('CG Position in % of Chord','fontweight','bold','FontSize',12);
xlabel('Station # on the craft','fontweight','bold','FontSize',12);
xlim([-3,3]), ylim([0,100]);
set(gca,'Ydir','reverse');
set(gca,'Xticklabel',{' ','3','1','0','2','4'});
text(span,stats_rrv.mean_cg,txt_cg_rrv,'HorizontalAlignment','left','fontweight','bold','fontsize',12)
...
ylabel('Mass of spine in grams','fontweight','bold','FontSize',12);
xlabel('Station # on the craft','fontweight','bold','FontSize',12);
xlim([-3,3]);
set(gca,'Ydir','reverse');
set(gca,'Xticklabel',{' ','3','1','0','2','4'});
text(span,stats_atv.mean_mass_spine,txt_mass_atv,'HorizontalAlignment','left','fontweight','bold','fontsize',12)

subplot(2,1,2)
errorbar(span,stats_rrv.mean_mass_spine,stats_rrv.stdm,'r.','LineWidth',2);
title(['RRV config 1 (average total mass = ',num2str(round(sum(stats_rrv.mean_mass_spine)),5),' g) ']);
ylabel('Mass of spine in grams','fontweight','bold','FontSize',12);
xlabel('Station # on the craft','fontweight','bold','FontSize',12);
xlim([-3,3]);
set(gca,'Ydir','reverse');
set(gca,'Xticklabel',{' ','3','1','0','2','4'});
text(span,stats_rrv.mean_mass_spine,txt_mass_rrv,'HorizontalAlignment','left','fontweight','bold','fontsize',12)
